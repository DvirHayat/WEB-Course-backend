...
This project is a backend service for managing users in [Social Network](https://social-network-bfr9.vercel.app/), built with **Next.js** and **MongoDB**. It provides various endpoints for user authentication, registration, and administration. The project also uses **Mongoose** for database interactions.
